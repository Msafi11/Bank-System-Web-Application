...
CREATE TABLE `bankaccount` (
  ...
  PRIMARY KEY (`BankAccountID`,`Customer_CustomerID`),
  KEY `fk_BankAccount_Customer_idx` (`Customer_CustomerID`),
  CONSTRAINT `fk_BankAccount_Customer` FOREIGN KEY (`Customer_CustomerID`) REFERENCES `customer` (`CustomerID`)
...
INSERT INTO `bankaccount` VALUES (1,'2020-01-01',1000,1);
...
CREATE TABLE `banktransaction` (
  ...
  `BTAmount` int NOT NULL,
  `BTFromAccount` int NOT NULL,
  `BTToAccount` int NOT NULL,
  `BankAccount_BankAccountID` int NOT NULL,
  PRIMARY KEY (`BankTransactionID`,`BankAccount_BankAccountID`),
  KEY `fk_BankTransaction_BankAccount1_idx` (`BankAccount_BankAccountID`),
  CONSTRAINT `fk_BankTransaction_BankAccount1` FOREIGN KEY (`BankAccount_BankAccountID`) REFERENCES `bankaccount` (`BankAccountID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customer` VALUES (1,'safi','ain','01156353309','12345'),(2,'ahmed','214ain','01121165294','1234');
...
-- Dump completed on 2020-12-27 16:20:03
